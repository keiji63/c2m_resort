...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2017 at 09:17 AM
...
CREATE TABLE `affiliate_user` (
  ...
  `aff_tel` varchar(255) CHARACTER SET latin1 NOT NULL,
  `aff_email` varchar(255) CHARACTER SET latin1 NOT NULL,
  `aff_pass` varchar(255) CHARACTER SET latin1 NOT NULL,
  `aff_income_all` int(10) NOT NULL DEFAULT '100',
  `aff_income_withdrawal` int(10) NOT NULL DEFAULT '100',
  `create_time` varchar(255) CHARACTER SET latin1 NOT NULL
...
CREATE TABLE `affiliate_withdraw` (
  ...
  `w_status` int(1) NOT NULL COMMENT '0รอโอน,1โอนแล้ว,2ยกเลิก',
...
--
-- Table structure for table `food_brand`
--

CREATE TABLE `food_brand` (
  `food_brand_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `food_brand_name` varchar(255) NOT NULL,
  `food_brand_address` varchar(255) NOT NULL,
  `food_brand_tax_number` varchar(100) NOT NULL,
  `food_brand_tel` varchar(20) NOT NULL,
  `add_time` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `food_list` (
  ...
  `food_price` decimal(65,2) NOT NULL,
  `food_category_id` int(11) NOT NULL,
  `food_brand_id` int(11) NOT NULL,
  `food_status` int(1) NOT NULL COMMENT '0=พร้อมขาย,1=อาหารหมด',
  `user_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
CREATE TABLE `food_order` (
  ...
  `food_order_status` int(1) NOT NULL,
  `user_id` int(11) NOT NULL,
  `food_brand_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `create_date` varchar(255) NOT NULL
...
--
-- Table structure for table `landingpage_center`
--

CREATE TABLE `landingpage_center` (
  `lp_center_id` int(11) NOT NULL,
  `lp_center_name` varchar(100) NOT NULL,
  `lp_center_des` longtext NOT NULL,
  `lp_center_pic` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `landingpage_owner`
--

CREATE TABLE `landingpage_owner` (
  `lp_owner_id` int(11) NOT NULL,
  `lp_owner_des` longtext NOT NULL,
...
CREATE TABLE `renew` (
  `renew_id` int(10) NOT NULL,
  `owner_id` int(10) NOT NULL,
  `total_amount` varchar(10) CHARACTER SET latin1 NOT NULL,
  `image` varchar(255) CHARACTER SET latin1 NOT NULL,
  `time_transfer` varchar(30) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `sale_list_header` (
  ...
  `discount_last` int(11) NOT NULL COMMENT 'ส่วนลดท้ายบิล',
  `adddate` varchar(255) NOT NULL,
  `owner_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
...
--
-- Table structure for table `template_center`
--

CREATE TABLE `template_center` (
  `temp_center_id` int(11) NOT NULL,
  `temp_center_name` varchar(100) NOT NULL,
  `temp_center_des` longtext NOT NULL,
  `temp_center_pic` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `template_owner`
--

CREATE TABLE `template_owner` (
  `temp_owner_id` int(11) NOT NULL,
  `temp_owner_des` longtext NOT NULL,
  `owner_id` int(11) NOT NULL,
  `add_time` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `thai_amphur`
--

CREATE TABLE `thai_amphur` (
...
--
-- Dumping data for table `thai_amphur`
--

INSERT INTO `thai_amphur` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `POSTCODE`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
--
-- Table structure for table `thai_district`
--

CREATE TABLE `thai_district` (
...
--
-- Dumping data for table `thai_district`
--

INSERT INTO `thai_district` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
--
-- Table structure for table `thai_geography`
--

CREATE TABLE `thai_geography` (
  `GEO_ID` int(5) NOT NULL,
  `GEO_NAME` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `thai_geography`
--

INSERT INTO `thai_geography` (`GEO_ID`, `GEO_NAME`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `thai_province`
--
...
--
-- Dumping data for table `thai_province`
--

INSERT INTO `thai_province` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
--
-- Table structure for table `type_bu`
--

CREATE TABLE `type_bu` (
  `type_bu_id` int(11) NOT NULL,
  `type_bu_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `type_owner`
--

CREATE TABLE `type_owner` (
  `type_owner_id` int(11) NOT NULL,
  `type_owner_name` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `affiliate_withdraw`
--
...
--
-- Indexes for table `food_brand`
--
ALTER TABLE `food_brand`
  ADD PRIMARY KEY (`food_brand_id`);
...
--
-- Indexes for table `landingpage_center`
--
ALTER TABLE `landingpage_center`
  ADD PRIMARY KEY (`lp_center_id`);

--
-- Indexes for table `landingpage_owner`
--
ALTER TABLE `landingpage_owner`
  ADD PRIMARY KEY (`lp_owner_id`);
...
--
-- Indexes for table `template_center`
--
ALTER TABLE `template_center`
  ADD PRIMARY KEY (`temp_center_id`);

--
-- Indexes for table `template_owner`
--
ALTER TABLE `template_owner`
  ADD PRIMARY KEY (`temp_owner_id`);

--
-- Indexes for table `thai_amphur`
--
ALTER TABLE `thai_amphur`
  ADD PRIMARY KEY (`AMPHUR_ID`);

--
-- Indexes for table `thai_district`
--
ALTER TABLE `thai_district`
  ADD PRIMARY KEY (`DISTRICT_ID`);

--
-- Indexes for table `thai_geography`
--
ALTER TABLE `thai_geography`
  ADD PRIMARY KEY (`GEO_ID`);

--
-- Indexes for table `thai_province`
--
ALTER TABLE `thai_province`
  ADD PRIMARY KEY (`PROVINCE_ID`);

--
-- Indexes for table `type_bu`
--
ALTER TABLE `type_bu`
  ADD PRIMARY KEY (`type_bu_id`);

--
-- Indexes for table `type_owner`
--
ALTER TABLE `type_owner`
  ADD PRIMARY KEY (`type_owner_id`);
...
--
ALTER TABLE `affiliate_user`
  MODIFY `aff_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `affiliate_withdraw`
--
ALTER TABLE `affiliate_withdraw`
...
--
ALTER TABLE `apartment_brand`
  MODIFY `apartment_brand_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `apartment_room`
  MODIFY `apartment_room_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `food_brand`
  MODIFY `food_brand_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `food_table`
  MODIFY `food_table_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `landingpage_center`
--
ALTER TABLE `landingpage_center`
  MODIFY `lp_center_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `landingpage_owner`
--
ALTER TABLE `landingpage_owner`
  MODIFY `lp_owner_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `renew`
  MODIFY `renew_id` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `template_center`
--
ALTER TABLE `template_center`
  MODIFY `temp_center_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `template_owner`
--
ALTER TABLE `template_owner`
  MODIFY `temp_owner_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `thai_amphur`
--
ALTER TABLE `thai_amphur`
  MODIFY `AMPHUR_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=999;
--
-- AUTO_INCREMENT for table `thai_district`
--
ALTER TABLE `thai_district`
  MODIFY `DISTRICT_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8861;
--
-- AUTO_INCREMENT for table `thai_geography`
--
ALTER TABLE `thai_geography`
  MODIFY `GEO_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `thai_province`
--
ALTER TABLE `thai_province`
  MODIFY `PROVINCE_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT for table `type_bu`
--
ALTER TABLE `type_bu`
  MODIFY `type_bu_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `type_owner`
--
ALTER TABLE `type_owner`
  MODIFY `type_owner_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `wh_importproduct_detail`
  MODIFY `importproduct_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `wh_importproduct_header`
--
ALTER TABLE `wh_importproduct_header`
  MODIFY `importproduct_header_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
